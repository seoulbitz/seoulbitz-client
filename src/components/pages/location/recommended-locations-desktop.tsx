...
const { Swiper: SwiperComponent, SwiperSlide } = SwiperReact;

const LocationItem = () => {
  return (
    <Div>
      <Div display={[null, null, null]} position="relative" paddingTop="75%">
        <Div
          position="absolute"
          top="0"
          left="0"
...
const RecommendedLocationsDesktop: FC<any> = (props) => {
...
export default RecommendedLocationsDesktop;

...
export const futura = css`
  @font-face {
    ...
    font-weight: 400;
    font-style: 'book';
    src: local('Futura PT Book'), url('/fonts/futura/FuturaPT-Book.eot'),
  ...
  @font-face {
    ...
    font-weight: 500;
    font-style: 'medium';
    src: local('Futura PT Medium'), url('/fonts/futura/FuturaPT-Medium.eot'),
